...
# From https://www.reddit.com/r/everybodycodes/comments/1h2yc5e/2024_q21_message_to_the_knights/

import itertools as it
from typing import Final, TypeAlias, TypeVar

MESSAGE: Final = """1024:LLLLLLRRRLRRRRRLLRRLRRRRLRRRLLLLRRRLLLLLLRRRLLLLLRRLRLRRRLRL
...
def _decode(data: str):
    ops_line, grid_in = data.split("\n\n", 1)
    rounds_s, ops_in = ops_line.split(":", 1)
    rounds = int(rounds_s)
    ops = it.cycle(ops_in)
